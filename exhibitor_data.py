...
done_exhibitors = [
    ...
    {
        'username': 'monique_fletcher',
        'password': 'password',
        'first_name': 'Monique',
        'last_name': 'Fletcher',
        'email': 'kidsdumonde@sbcglobal.net',
        'company': 'Kids Du Monde',
        'website': '',
        'address': '110 E. 9th St., Suite A678',
        'address2': '',
        'city': 'Los Angeles',
        'state': 'CA',
        'zip': '90079',
        'phone': '213-689-8779',
        'fax': '213-689-7706',
        'lines': """Deux Par Deux * Eliane et Lena * Isobella & Chloe * Berlingot * Lemon Loves Lime * Gnu Brand * Joan Calabrese for Mon Cheri * Lotus Springs * Noodle & Boo * Nowali * Too Cuties * Tom Girl's Clothing * Anja's Dream""",
    },
    {
        'username': 'jane_han',
        'password': 'password',
